...
const PdfContent = ({
  ...
  projetValue = 'Default Projet Value',
  logoUrl,
  ...
  return (
    <Document>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
          ...
          <View style={{ marginLeft: 'auto', marginRight: 'auto' }}>
            <Text style={{  ...styles.title, color : '#5ec2d7',fontWeight: 'bold'}}>Devis</Text>
          </View>
        </View>
        ...
        <View style={styles.tableContainer}>
          <Text style={[styles.tableHeaderCell, styles.blueColumn, styles.whiteText, styles.blueColumn]}>Description</Text>
          <Text style={[styles.tableHeaderCell, styles.blueColumn, styles.whiteText, styles.blueColumn]}>Quantité</Text>
          <Text style={[styles.tableHeaderCell, styles.blueColumn, styles.whiteText, styles.blueColumn]}>Montant</Text>
          <Text style={[styles.tableHeaderCell, styles.blueColumn, styles.whiteText, styles.blueColumn]}>Total</Text>
        </View>
        {data.map((row, index) => (
    ...
    <Text style={styles.remarqueText}>{remarque}</Text> {/* Display the remarque prop here */}
  </View>
